...
;then add the remainder for that arrangement
	      ...
	      (conjoin-prop (A81 A82 A81c) A81d)
	      (number (product) A82)
...
;award recipients sit on the auditorium stage
              ((award-recipients (obj_recipients) A1)
               ...
               (sit-on (obj_recipients obj_stage) A3)
;the number of award recipients is num_total_A
               (number-of_A (obj_recipients num_total_A) A4)
;dividing recipients by 9 or 6 leaves a non-zero remainder of 1
               (divide_A (num_total_A num9 quotient_A1) A5)
               (remainder-of_A (A5 num1) A6)
               (not-equal_A (num1 num0a) A7)
               (number-left-out (obj_recipients obj_stage num1) A8)
               (divide_A (num_total_A num6a quotient_A2) A9)
               (remainder-of_A (A9 num1) A10)
;dividing recipients by 4 leaves a non-zero remainder of 3
               (divide_A (num_total_A num4a quotient_A3) A11)
               (remainder-of_A (A11 num3) A12)
               (not-equal_A (num3 num0a) A13)
               (number-left-out (obj_recipients obj_stage num3) A14)
;assistant dean 1 suggests dividing by 9, assistant dean 2 suggests 6,
;and both suggest 4.
               (person_A (obj_asst1) A15)
               (person_A (obj_asst2) A16)
               (suggests_A (obj_asst1 A5) A17)
               (suggests_A (obj_asst2 A9) A18)
               (suggests_A (obj_asst1 A11) A19)
               (suggests_A (obj_asst2 A11) A20)
;dean orders division by 5, which results in 0 remainder
               (person_A (obj_dean) A21)
               (orders (obj_dean A23) A22)
               (divide_A (num_total_A num5a quotient_A4) A23)
               (remainder-of_A (A23 num0a) A24)
;division by 5 is a success because the remainder is 0
               (success_A (A23) A25)
               (cause_A (A24 A25) A26)
;all the numbers mentioned are numbers
               (number_A (num_total_A) A27)
               (number_A (num9) A28)
               (number_A (num6a) A29)
               (number_A (num4a) A30)
               (number_A (num5a) A31)
               ...
               (number_A (num0a) A33)
               (number_A (num3) A34)
               (number_A (quotient_A1) A35)
               (number_A (quotient_A2) A36)
               (number_A (quotient_A3) A37)
               (number_A (quotient_A4) A38)
;various numbers have specific values
               (nine (num9) A39)
               (six_A (num6a) A40)
               (four_A (num4a) A41)
...
;attempts, respectively
               ...
               (second-try_A (A9) A61)
               (third-try_A (A11) A62)
               (fourth-try_A (A23) A63)
;9, 6, 4, and 5 are the first to fourth divisors considered, respectively
               (first-divisor_A (num9) A64)
               (second-divisor_A (num6a) A65)
               (third-divisor_A (num4a) A66)
               (fourth-divisor_A (num5a) A67)
...
;the goal is to determine num_total_A
               ((known_A (num_total_A) A68)
;which can be divided by num_Ax to give quotient_Ax with 0 remainder
               (divide_A (num_total_A num_Ax quotient_Ax) A69)
               (remainder-of_A (A69 num0a) A70)
;where num_Ax = 5 and quotient_Ax = quotient_A4
               (equal_A (num_Ax num5a) A71)
               (equal_A (quotient_Ax quotient_A4) A72)
;and num_total_A is greater than 20 and less than 120
               (greater-than (num_total_A num20) A73)
               (less-than (num_total_A num120) A74)
               (number_A (num_Ax) A75)
               (number_A (quotient_Ax) A76)
               (number_A (num20) A77)
               (number_A (num120) A78)
               (twenty (num20) A79)
               (one-hundred-twenty (num120) A80)
